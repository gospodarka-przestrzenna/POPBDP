...
This guide provides instructions for translating the POPBDP plugin into different languages. The steps below describe how to extract translatable strings, update translation files, and compile them for use.
Prerequisites
...
i18n/
  └── [language_code]/
      └── LC_MESSAGES/
          ├── POPBDP.pot  # Template file for translations
          ├── POPBDP.po   # Translations for the language
          └── POPBDP.mo   # Compiled translations
```
Extracting Translatable Strings

Run the following command to extract all translatable strings from the plugin's Python files:
`find . -name "*.py" | xargs xgettext -d POPBDP -o i18n/[language_code]/LC_MESSAGES/POPBDP.pot`
...
`msgmerge -U i18n/[language_code]/LC_MESSAGES/POPBDP.po i18n/[language_code]/LC_MESSAGES/POPBDP.pot`
...
`msgfmt i18n/[language_code]/LC_MESSAGES/POPBDP.po -o i18n/[language_code]/LC_MESSAGES/POPBDP.mo`
...
`cp i18n/en/LC_MESSAGES/POPBDP.pot i18n/[language_code]/LC_MESSAGES/POPBDP.po`
...
# Review translations in i18n/pl/LC_MESSAGES/POPBDP.po
